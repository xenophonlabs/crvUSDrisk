...
class ControllerMetrics(Metric):
    ...
    def config(self) -> dict:
        ...
        for controller in self.controllers:
            ...
            summary[controller_str + "_system_health"] = "mean"
            summary[controller_str + "_bad_debt"] = "mean"
            summary[controller_str + "_num_loans"] = "mean"
            summary[controller_str + "_total_debt"] = "mean"
            summary[controller_str + "_users_to_liquidate"] = "mean"
        # TODO plot config
    ...
    def compute(self) -> Dict[str, Union[int, float]]:
        ...
        for controller in self.controllers:
            ...
            res.append(controller.total_debt())
